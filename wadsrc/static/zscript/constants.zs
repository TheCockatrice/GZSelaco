...
enum ELOFFlags
{
	...
	CLOFF_BLOCKLOS_ALWAYS = 	0x8000000,	// @Cockatrice - Always stop on BLOCKLOS flag, regardless of other flags
	...
	CLOFF_SKIPLOS =				0x80000000, // Skip anything with BLOCKLOS
