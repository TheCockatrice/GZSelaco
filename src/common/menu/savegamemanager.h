...
{
	int saveDate, saveFlags, elapsedTime, levelNum;
	FString SaveTitle;
	FString Filename;
...
public:
	void NotifyNewSave(const FString &file, const FString &title, int saveDate, bool okForQuicksave, bool forceQuicksave, int elapsedTime, int levelnum, int32_t flags);
	void ClearSaveGames();
